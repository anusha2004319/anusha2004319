...
End-to-end ML pipeline on King County housing data — scikit-learn regression model with a live Streamlit app for instant price estimates.  
`Python` `scikit-learn` `pandas` `Streamlit`

### 🏆 [AI Candidate Ranking — India Runs Challenge](https://github.com/anusha2004319/india-runs-ai-ranking)
Built for the India Runs Data & AI Challenge — ranks candidates by skills, career history, and behavioral signals using AI scoring.  
`Python` `AI/ML`
